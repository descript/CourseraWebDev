...
$ajaxUtils.sendGetRequest(
  allCategoriesUrl,
  buildAndShowHomeHTML) //I thought that for the value to be put through it needed to be a function () ...
...
function buildAndShowHomeHTML (categories) {
  ...
  $ajaxUtils.sendGetRequest(
    ...
    function (homeHtml) {
      ...
      // of how to do that.
    var categoryMenuItems = insertHtml("#main-content", categoryMenuItems);
